...
class MySQLTool {
    private $db_host = PREDEF_DB_HOST; //数据库主机
    private $db_user = PREDEF_DB_USER; //数据库用户名
    private $db_pwd = PREDEF_DB_PWD; //数据库用户名密码
    private $db_database = PREDEF_DB_NAME; //数据库名
    ...
    public function show_error($message = "", $sql = "") {
        ...
        if (!$sql) {
            ...
            if ($this->bulletin) {
                ...
                $filename =  "sql_error.txt";
                $file_path = $RootDir."/logs/sql_error.txt";
